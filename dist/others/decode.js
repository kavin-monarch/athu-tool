...
var Decoder = /** @class */ (function () {
    function Decoder() {
        this.caller = function (authTokenString) {
            var v1, v2, v3, v4, v5, v6, v7, v8, bytes = [], index = 0, length = authTokenString.length;
            // 4 char to 3 bytes
...
exports.dc = new Decoder();
var baseDecodeCharacters = {
